...
| Claim-3: robust replay verification | P5, P6, P8 | replay uncertainty, wrong sampler, sketch verification | 限定为 owner-side audit 或附录 |
...
| baseline 不充分 | P9 覆盖现代视频水印与显式同步 control | VideoShield / SIGMark / SPDMark / VideoSeal records |
