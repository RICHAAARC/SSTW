    ...
    package_manifest = {
        ...
        "decision_summary": {
            ...
            **mechanism_summary,
            ...
            "pilot_paper_gate_decision": fpr01_pilot_decision.get("pilot_paper_gate_decision"),
            "fpr01_pilot_claim_support_status": fpr01_pilot_decision.get("claim_support_status"),
            "pilot_paper_claim_support_status": fpr01_pilot_decision.get("claim_support_status"),
            "pilot_paper_result_level": fpr01_pilot_decision.get("paper_result_level"),
            "pilot_paper_protocol_level": fpr01_pilot_decision.get("paper_protocol_level"),
            "pilot_paper_protocol_difference_from_full_paper": fpr01_pilot_decision.get("paper_protocol_difference_from_full_paper"),
            "pilot_paper_protocol_matches_full_paper": fpr01_pilot_decision.get("pilot_paper_protocol_matches_full_paper"),
            "pilot_paper_claim_allowed": fpr01_pilot_decision.get("pilot_paper_claim_allowed"),
            "pilot_paper_external_baseline_trace_count": fpr01_pilot_decision.get("pilot_paper_external_baseline_trace_count"),
            "pilot_paper_external_baseline_trace_count_min": fpr01_pilot_decision.get("pilot_paper_external_baseline_trace_count_min"),
            "pilot_paper_modern_external_baseline_formal_measured_adapter_count": fpr01_pilot_decision.get("modern_external_baseline_formal_measured_adapter_count"),
            "pilot_paper_internal_ablation_trace_count_min": fpr01_pilot_decision.get("pilot_paper_internal_ablation_trace_count_min"),
            "pilot_paper_missing_external_baseline_adapter_names": fpr01_pilot_decision.get("missing_external_baseline_adapter_names"),
            "pilot_paper_missing_modern_external_baseline_formal_adapter_names": fpr01_pilot_decision.get("missing_modern_external_baseline_formal_adapter_names"),
            "pilot_paper_missing_internal_ablation_variants": fpr01_pilot_decision.get("missing_internal_ablation_variants"),
