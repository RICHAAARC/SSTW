...
def build_reviewer_evidence_index_command(layout: dict[str, str]) -> list[str]:
    """构造三层论文主张的 governed 审稿证据索引命令."""
    return [
        sys.executable,
        "-m",
        "experiments.generative_video_model_probe.reviewer_evidence_index",
        "--run-root",
        layout["drive_run_root"],
    ]
...
def build_configured_colab_stage_command(
    ...
    *,
    ...
    simple_builders = {
        ...
        "reviewer_evidence_index": build_reviewer_evidence_index_command,
