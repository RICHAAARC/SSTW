...
from evaluation.protocol.package_naming import (
...
RUNTIME_ATTACK_PACKAGE_RELPATHS = (
    ...
    "records/cross_sample_adaptive_video_attack_records.jsonl",
    "reports/runtime_attack_report.md",
    "tables/runtime_attack_table.csv",
    "tables/cross_sample_adaptive_video_attack_table.csv",
    "attacked_videos",
)
...
PAPER_EVIDENCE_POSTPROCESS_PACKAGE_RELPATHS = (
    ...
    "reports/formal_adaptive_attack_execution_report.md",
